...
public class FlowerPopulator extends BlockPopulator
{
	...
	public void populate(World world, Random random, Chunk chunk)
	{
		...
		List<Biome> iceBiomes = Arrays.asList(Biome.TAIGA, Biome.TAIGA_HILLS,
				Biome.ICE_PLAINS, Biome.ICE_MOUNTAINS, Biome.FROZEN_RIVER,
				Biome.FROZEN_OCEAN);
					...
					if (y > 4)
					{
						...
						if (ground.getType() == Material.GRASS)
						{
							if (biome == Biome.PLAINS)
							{
								...
								{
									block.setType((this.random.nextInt(100) < 75) ? Material.YELLOW_FLOWER
											: Material.RED_ROSE);
								}
							} else if (biome != Biome.DESERT
									&& iceBiomes.contains(biome) == false)
							{
