...
public class WorldGenLavaCustom extends WorldGenerator
{
    private int blockIndex = 10; // Lava
                ...
                for (var32 = 0; var32 < 16; ++var32)
                {
                    for (var10 = 0; var10 < 8; ++var10)
                    {
                        if (var6[(var8 * 16 + var32) * 8 + var10])
                        {
                        	...
                        	if(!var12.isSolid())
                        		continue;
                            par1World.setTypeId(par3 + var8, par4 + var10, par5 + var32, var10 >= 4 ? 0 : this.blockIndex);
                        }
                    }
                }
            }
